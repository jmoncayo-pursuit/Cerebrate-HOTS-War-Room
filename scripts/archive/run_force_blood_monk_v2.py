...
str_analysis = json.dumps(analysis_json)
db.conn.execute('UPDATE matches SET analysis = ? WHERE id = ?', (str_analysis, match_id))
db.conn.commit()
print(f'Successfully force-updated analysis for {match_id} with Blood Monk version.')
