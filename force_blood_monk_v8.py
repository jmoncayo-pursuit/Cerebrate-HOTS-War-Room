...
# Direct connection to avoid any class init issues
...
conn.commit()
conn.close()
print(f'Successfully force-updated analysis for {match_id} with simplified format and corrected death count.')
